...
void main() {
  group('SupabaseHomeRemoteDatasource', () {
    test('aggregates typed DTOs from Supabase table payloads', () async {
      final datasource = SupabaseHomeRemoteDatasource(
        ...
        featuredRestaurantRowsLoader: () async => [
          ...
          },
          {
            'id': 'sushi_zen',
            'name': 'Sushi Zen',
            'image_asset_path': 'restaurants/sushi_zen/cover.webp',
            'rating': 4.9,
        ...
        restaurantCategoryLinkRowsLoader: () async => [
          ...
          {'restaurant_id': 'sushi_zen', 'category_id': 'all', 'sort_order': 0},
        ],
      );
      ...
      expect(payload.featuredRestaurants, [
        HomeRestaurantDto(
          id: 'burger_artisan_collective',
          name: 'Burger Artisan Collective',
          imageAssetPath:
        ...
        HomeRestaurantDto(
          ...
          imageAssetPath:
              'https://example.supabase.co/storage/v1/object/public/'
              'catalog-media/restaurants/sushi_zen/cover.webp',
          rating: 4.9,
    ...
    test(
      'throws a HomeRemoteException when no active promotion is returned',
      () {
        final datasource = SupabaseHomeRemoteDatasource(
          client: _testClient,
          mediaUrlResolver: _mediaUrlResolver,
    ...
    test('maps media resolution failures to HomeRemoteException', () {
      final datasource = SupabaseHomeRemoteDatasource(
        client: _testClient,
        mediaUrlResolver: _mediaUrlResolver,
        categoryRowsLoader: () async => const [],
      ...
      expect(datasource.getHomeFeed(), throwsA(isA<HomeRemoteException>()));
    });
  });
}
