---
name: fd-architect
description: FlowDelivery software architect. Use when evaluating architectural impact, preserving MVVM / Clean Architecture / feature-first, deciding when to write an ADR, validating dependency direction, keeping Supabase out of the UI, or planning incremental structural changes.
---
# Architect Skill
